...
export const TOP_GARDENS: Garden[] = [
  ...
  },
  {
    ...
    description: "Produces fresh and lively teas with a clean apperance, perfect for everyday drinking.",
  ...
  },
  {
    ...
    description: "Produces bright, brisk teas with a clean and refreshing apperance.",
  ...
  },
  {
    ...
    location: "Lakhimpur, Assam",
    description: "Specializes in high grade teas with deep color, strong cup, and premium consistency.",
